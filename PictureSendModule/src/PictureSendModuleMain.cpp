/**
 * @file PictureSendModuleMain.cpp
 * @brief ...
 *
 ...
 * have this file and the PictureSendModule header and code in a separate "aim" directory.
 */
int main(int argc, char *argv[])  {
	PictureSendModuleExt *m = new PictureSendModuleExt();
