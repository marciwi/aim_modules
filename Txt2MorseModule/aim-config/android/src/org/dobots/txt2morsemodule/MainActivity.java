package org.dobots.txt2morsemodule;
...
import org.dobots.txt2morsemodule.aim.*;

public class MainActivity extends Activity {
private static final String TAG = "MainActivity";
private static final String MODULE_NAME = "Txt2MorseModule";
...
protected void onCreate(Bundle savedInstanceState) {
	...
	private void startService() {
		...
		intent.setClassName("org.dobots.txt2morsemodule", "org.dobots.txt2morsemodule.aim.Txt2MorseModuleService");
...
//		finish();
    ...
    private boolean checkServiceRunning() {
		...
		for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
			if (Txt2MorseModuleService.class.getName().equals(service.service.getClassName())) {
