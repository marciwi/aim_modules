package org.dobots.txt2morsemodule.aim;
...
public class Txt2MorseModuleService extends Service {
	private static final String TAG = "Txt2MorseModuleService";
...
//	}
	...
	private class AIMRun extends AsyncTask<Integer, Void, Boolean> {
		protected Boolean doInBackground(Integer... id) {
			...
			int input = 3;
			Txt2MorseModule aim = new Txt2MorseModule();
...
//		}
	...
	// static constructor
	static {
		System.loadLibrary("Txt2MorseModule");
	}
