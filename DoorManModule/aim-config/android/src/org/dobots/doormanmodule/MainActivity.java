package org.dobots.doormanmodule;
...
import org.dobots.doormanmodule.aim.*;

public class MainActivity extends Activity {
private static final String TAG = "MainActivity";
private static final String MODULE_NAME = "DoorManModule";
...
protected void onCreate(Bundle savedInstanceState) {
	...
	private void startService() {
		...
		intent.setClassName("org.dobots.doormanmodule", "org.dobots.doormanmodule.aim.DoorManModuleService");
...
//		finish();
    ...
    private boolean checkServiceRunning() {
		...
		for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
			if (DoorManModuleService.class.getName().equals(service.service.getClassName())) {
