package org.dobots.doormanmodule.aim;
...
public class DoorManModuleService extends Service {
	private static final String TAG = "DoorManModuleService";
...
//	}
	...
	private class AIMRun extends AsyncTask<Integer, Void, Boolean> {
		protected Boolean doInBackground(Integer... id) {
			...
			int input = 3;
			DoorManModule aim = new DoorManModule();
...
//		}
	...
	// static constructor
	static {
		System.loadLibrary("DoorManModule");
	}
