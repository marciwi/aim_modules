package org.dobots.clustermodule.aim;
...
public class ClusterModuleService extends Service {
	private static final String TAG = "ClusterModuleService";
...
//	}
	...
	private class AIMRun extends AsyncTask<Integer, Void, Boolean> {
		protected Boolean doInBackground(Integer... id) {
			...
			int input = 3;
			ClusterModule aim = new ClusterModule();
...
//		}
	...
	// static constructor
	static {
		System.loadLibrary("ClusterModule");
	}
