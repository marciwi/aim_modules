package org.dobots.clustermodule;
...
import org.dobots.clustermodule.aim.*;

public class MainActivity extends Activity {
private static final String TAG = "MainActivity";
private static final String MODULE_NAME = "ClusterModule";
...
protected void onCreate(Bundle savedInstanceState) {
	...
	private void startService() {
		...
		intent.setClassName("org.dobots.clustermodule", "org.dobots.clustermodule.aim.ClusterModuleService");
...
//		finish();
    ...
    private boolean checkServiceRunning() {
		...
		for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
			if (ClusterModuleService.class.getName().equals(service.service.getClassName())) {
