package org.dobots.morsepifacemodule;
...
import org.dobots.morsepifacemodule.aim.*;

public class MainActivity extends Activity {
private static final String TAG = "MainActivity";
private static final String MODULE_NAME = "MorsePifaceModule";
...
protected void onCreate(Bundle savedInstanceState) {
	...
	private void startService() {
		...
		intent.setClassName("org.dobots.morsepifacemodule", "org.dobots.morsepifacemodule.aim.MorsePifaceModuleService");
...
//		finish();
    ...
    private boolean checkServiceRunning() {
		...
		for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
			if (MorsePifaceModuleService.class.getName().equals(service.service.getClassName())) {
