package org.dobots.morsepifacemodule.aim;
...
public class MorsePifaceModuleService extends Service {
	private static final String TAG = "MorsePifaceModuleService";
...
//	}
	...
	private class AIMRun extends AsyncTask<Integer, Void, Boolean> {
		protected Boolean doInBackground(Integer... id) {
			...
			int input = 3;
			MorsePifaceModule aim = new MorsePifaceModule();
...
//		}
	...
	// static constructor
	static {
		System.loadLibrary("MorsePifaceModule");
	}
