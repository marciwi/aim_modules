package org.dobots.morse2txtmodule.aim;
...
public class Morse2TxtModuleService extends Service {
	private static final String TAG = "Morse2TxtModuleService";
...
//	}
	...
	private class AIMRun extends AsyncTask<Integer, Void, Boolean> {
		protected Boolean doInBackground(Integer... id) {
			...
			int input = 3;
			Morse2TxtModule aim = new Morse2TxtModule();
...
//		}
	...
	// static constructor
	static {
		System.loadLibrary("Morse2TxtModule");
	}
