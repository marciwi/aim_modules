package org.dobots.morse2txtmodule;
...
import org.dobots.morse2txtmodule.aim.*;

public class MainActivity extends Activity {
private static final String TAG = "MainActivity";
private static final String MODULE_NAME = "Morse2TxtModule";
...
protected void onCreate(Bundle savedInstanceState) {
	...
	private void startService() {
		...
		intent.setClassName("org.dobots.morse2txtmodule", "org.dobots.morse2txtmodule.aim.Morse2TxtModuleService");
...
//		finish();
    ...
    private boolean checkServiceRunning() {
		...
		for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
			if (Morse2TxtModuleService.class.getName().equals(service.service.getClassName())) {
