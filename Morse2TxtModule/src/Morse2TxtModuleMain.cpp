/**
 * @file Morse2TxtModuleMain.cpp
 * @brief Entry function for Morse2TxtModule
 *
 ...
 * have this file and the Morse2TxtModule header and code in a separate "aim" directory.
 */
int main(int argc, char *argv[])  {
	Morse2TxtModuleExt *m = new Morse2TxtModuleExt();
