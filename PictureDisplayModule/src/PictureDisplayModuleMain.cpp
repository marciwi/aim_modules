/**
 * @file PictureDisplayModuleMain.cpp
 * @brief ...
 *
 ...
 * have this file and the PictureDisplayModule header and code in a separate "aim" directory.
 */
int main(int argc, char *argv[])  {
	PictureDisplayModuleExt *m = new PictureDisplayModuleExt();
